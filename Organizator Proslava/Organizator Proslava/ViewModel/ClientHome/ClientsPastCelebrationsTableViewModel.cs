...
namespace Organizator_Proslava.ViewModel.ClientHome
{
    public class ClientsPastCelebrationsTableViewModel
    {
        ...
        public ClientsPastCelebrationsTableViewModel(ICelebrationService celebrationService,
        ...
        public void Reload()
        {
            ...
            _celebrationService.ReadPastForClient(GlobalStore.ReadObject<BaseUser>("loggedUser").Id).ToList().ForEach(cr => PastCelebrations.Add(cr));
        }
    }
}
